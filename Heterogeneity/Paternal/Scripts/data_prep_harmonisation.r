...
Meta <- fread('/home/christopher/Desktop/child_gest/LDSC_Files/Paternal/Clean/pw_paternal_sex_gest.gz')
...
th <- fread('/home/christopher/Desktop/child_gest/LDSC_Files/paternal_top.csv', header=F)
...
path <- '/home/christopher/Desktop/child_gest/LDSC_Files/Paternal/top_hits_files'
...
lapply(seq_along(df_list), function(i){
  ...
  write.table(df_list[[i]], file = paste0('/home/christopher/Desktop/child_gest/LDSC_Files/Paternal/Cleaned_data', '/', df_name, '.txt'),sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
})
