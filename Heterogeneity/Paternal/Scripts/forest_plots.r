...
path <- '/child_gest/LDSC_Files/Paternal/Cleaned_data'
...
ht <- fread('/child_gest/LDSC_Files/Paternal/Clean/pw_paternal_sex_gest.gz')
...
# 
# write.table(df, '/child_gest/LDSC_Files/Paternal/Cleaned_data/combined_data.txt', col.names=T, row.names=F, quote=F,sep='\t')
